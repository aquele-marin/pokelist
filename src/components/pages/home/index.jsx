    ...
    return (
        <div>
                    ...
                    pokeList.map((pokemon) => {
                        return (
                            <tr>
                                ...
                                <td>
                                    {props.pokeController.searchPokemon(
                                        pokemon
                                    ) ? (
                                        <a
                                            href="#"
                                            onClick={() =>
                                                props.pokeController.deletePokemon(
                                                    pokemon
                                                )
                                            }
                                        >
                                        ...
                                        <a
                                            href="#"
                                            onClick={() =>
                                                props.pokeController.savePokemon(
                                                    pokemon
                                                )
                                            }
                                        >
            ...
            <div>
                <a
                    href="#"
                    onClick={() => setPokeListOffset(pokeListOffset + 20)}
                >
                    Próxima
                </a>
            </div>
